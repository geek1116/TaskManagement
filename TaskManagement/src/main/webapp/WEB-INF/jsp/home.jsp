...
<body>
	...
	<div id="wrapper">
			...
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					...
					<%  if(userName.equals("admin")){ %>
						<li><a href="<%=basePath%>listUser.action"><i class="fa fa-dashboard fa-fw"></i> 用户列表</a>
						</li>
					<%} else { %>
		...
		<div id="page-wrapper">
			...
			<button id="addBtn" class="btn btn-default" onclick="addTask()">添加任务</button>
			
			<%@include file="allAdminTask.jsp" %>
	...
	<script type="text/javascript">
		...
		function asceptTask(id) {
			$.ajax({
				type:"post",
				url:"<%=basePath%>/aceptTask.action",
				data:{"tid":id},
				success:function(data) {
		...
		function updateTask() {
			$.post(
				"<%=basePath%>updateTask.action",
				$("#edit_task_form").serialize(),
				function(data){
